...
enum s2mps19_common_irq {
	/* Top-level (common) block */
	S2MPS19_COMMON_IRQ_PMIC,
	S2MPS19_COMMON_IRQ_UNUSED,
};
...
enum s2mps19_irq {
	...
	S2MPS19_IRQ_PWRON1S,
	S2MPS19_IRQ_MRB,
#define S2MPS19_IRQ_PWRONF_MASK		BIT(0)
#define S2MPS19_IRQ_PWRONR_MASK		BIT(1)
#define S2MPS19_IRQ_JIGONBF_MASK	BIT(2)
#define S2MPS19_IRQ_JIGONBR_MASK	BIT(3)
#define S2MPS19_IRQ_ACOKBF_MASK		BIT(4)
#define S2MPS19_IRQ_ACOKBR_MASK		BIT(5)
#define S2MPS19_IRQ_PWRON1S_MASK	BIT(6)
#define S2MPS19_IRQ_MRB_MASK		BIT(7)
	...
	S2MPS19_IRQ_ADCDONE,
	S2MPS19_IRQ_WRST,
#define S2MPS19_IRQ_RTC60S_MASK		BIT(0)
#define S2MPS19_IRQ_RTCA1_MASK		BIT(1)
#define S2MPS19_IRQ_RTCA0_MASK		BIT(2)
#define S2MPS19_IRQ_SMPL_MASK		BIT(3)
#define S2MPS19_IRQ_RTC1S_MASK		BIT(4)
#define S2MPS19_IRQ_WTSR_MASK		BIT(5)
#define S2MPS19_IRQ_ADCDONE_MASK	BIT(6)
#define S2MPS19_IRQ_WRST_MASK		BIT(7)

	S2MPS19_IRQ_120C,
	S2MPS19_IRQ_140C,
	S2MPS19_IRQ_TSD,
	S2MPS19_IRQ_OVP,
	S2MPS19_IRQ_TIMEOUT1,
	S2MPS19_IRQ_TIMEOUT2,
	S2MPS19_IRQ_TIMEOUT3,
	S2MPS19_IRQ_SUB_SMPL,
#define S2MPS19_IRQ_120C_MASK		BIT(0)
#define S2MPS19_IRQ_140C_MASK		BIT(1)
#define S2MPS19_IRQ_TSD_MASK		BIT(2)
#define S2MPS19_IRQ_OVP_MASK		BIT(3)
#define S2MPS19_IRQ_TIMEOUT1_MASK	BIT(4)
#define S2MPS19_IRQ_TIMEOUT2_MASK	BIT(5)
#define S2MPS19_IRQ_TIMEOUT3_MASK	BIT(6)
#define S2MPS19_IRQ_SUB_SMPL_MASK	BIT(7)
	...
	S2MPS19_IRQ_OCP_B7M,
	S2MPS19_IRQ_OCP_B8M,
#define S2MPS19_IRQ_OCP_B1M_MASK	BIT(0)
#define S2MPS19_IRQ_OCP_B2M_MASK	BIT(1)
#define S2MPS19_IRQ_OCP_B3M_MASK	BIT(2)
#define S2MPS19_IRQ_OCP_B4M_MASK	BIT(3)
#define S2MPS19_IRQ_OCP_B5M_MASK	BIT(4)
#define S2MPS19_IRQ_OCP_B6M_MASK	BIT(5)
#define S2MPS19_IRQ_OCP_B7M_MASK	BIT(6)
#define S2MPS19_IRQ_OCP_B8M_MASK	BIT(7)

	S2MPS19_IRQ_OCP_B9M,
	S2MPS19_IRQ_OCP_B10M,
	S2MPS19_IRQ_OCP_B11M,
	S2MPS19_IRQ_OCP_B12M,
	S2MPS19_IRQ_OCP_BB,
	S2MPS19_IRQ_UV_BB,
	S2MPS19_IRQ_BB_NTR_DET,
#define S2MPS19_IRQ_OCP_B9M_MASK	BIT(0)
#define S2MPS19_IRQ_OCP_B10M_MASK	BIT(1)
#define S2MPS19_IRQ_OCP_B11M_MASK	BIT(2)
#define S2MPS19_IRQ_OCP_B12M_MASK	BIT(3)
#define S2MPS19_IRQ_OCP_BB_MASK		BIT(4)
#define S2MPS19_IRQ_UV_BB_MASK		BIT(5)
#define S2MPS19_IRQ_BB_NTR_DET_MASK	BIT(6)

	S2MPS19_IRQ_SC_LDO2M,
	S2MPS19_IRQ_SC_LDO13M,
	S2MPS19_IRQ_SC_LDO14M,
	S2MPS19_IRQ_SC_LDO15M,
	S2MPS19_IRQ_SC_LDO28M,
#define S2MPS19_IRQ_SC_LDO2M_MASK	BIT(0)
#define S2MPS19_IRQ_SC_LDO13M_MASK	BIT(1)
#define S2MPS19_IRQ_SC_LDO14M_MASK	BIT(2)
#define S2MPS19_IRQ_SC_LDO15M_MASK	BIT(3)
#define S2MPS19_IRQ_SC_LDO28M_MASK	BIT(4)
	...
	S2MPS19_IRQ_OC6,
	S2MPS19_IRQ_OC7,
#define S2MPS19_IRQ_OC0_MASK			BIT(0)
#define S2MPS19_IRQ_OC1_MASK			BIT(1)
#define S2MPS19_IRQ_OC2_MASK			BIT(2)
#define S2MPS19_IRQ_OC3_MASK			BIT(3)
#define S2MPS19_IRQ_OC4_MASK			BIT(4)
#define S2MPS19_IRQ_OC5_MASK			BIT(5)
#define S2MPS19_IRQ_OC6_MASK			BIT(6)
#define S2MPS19_IRQ_OC7_MASK			BIT(7)
