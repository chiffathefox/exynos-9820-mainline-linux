...
static const struct regmap_irq s2mps19_irqs[] = {
	REGMAP_IRQ_REG(S2MPS19_COMMON_IRQ_PMIC, 0, S2MPS19_COMMON_INT_SRC_PMIC),
	/* No documentation or other reference for remaining bits */
	REGMAP_IRQ_REG(S2MPS19_COMMON_IRQ_UNUSED, 0, GENMASK(7, 1)),
};

static const struct regmap_irq s2mps19_pmic_irqs[] = {
	REGMAP_IRQ_REG(S2MPS19_IRQ_PWRONF, 0, S2MPS19_IRQ_PWRONF_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_PWRONR, 0, S2MPS19_IRQ_PWRONR_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_JIGONBF, 0, S2MPS19_IRQ_JIGONBF_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_JIGONBR, 0, S2MPS19_IRQ_JIGONBR_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_ACOKBF, 0, S2MPS19_IRQ_ACOKBF_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_ACOKBR, 0, S2MPS19_IRQ_ACOKBR_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_PWRON1S, 0, S2MPS19_IRQ_PWRON1S_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_MRB, 0, S2MPS19_IRQ_MRB_MASK),

	REGMAP_IRQ_REG(S2MPS19_IRQ_RTC60S, 1, S2MPS19_IRQ_RTC60S_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_RTCA1, 1, S2MPS19_IRQ_RTCA1_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_RTCA0, 1, S2MPS19_IRQ_RTCA0_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_SMPL, 1, S2MPS19_IRQ_SMPL_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_RTC1S, 1, S2MPS19_IRQ_RTC1S_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_WTSR, 1, S2MPS19_IRQ_WTSR_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_ADCDONE, 1, S2MPS19_IRQ_ADCDONE_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_WRST, 1, S2MPS19_IRQ_WRST_MASK),

	REGMAP_IRQ_REG(S2MPS19_IRQ_120C, 2, S2MPS19_IRQ_120C_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_140C, 2, S2MPS19_IRQ_140C_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_TSD, 2, S2MPS19_IRQ_TSD_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OVP, 2, S2MPS19_IRQ_OVP_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_TIMEOUT1, 2, S2MPS19_IRQ_TIMEOUT1_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_TIMEOUT2, 2, S2MPS19_IRQ_TIMEOUT2_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_TIMEOUT3, 2, S2MPS19_IRQ_TIMEOUT3_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_SUB_SMPL, 2, S2MPS19_IRQ_SUB_SMPL_MASK),

	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B1M, 3, S2MPS19_IRQ_OCP_B1M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B2M, 3, S2MPS19_IRQ_OCP_B2M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B3M, 3, S2MPS19_IRQ_OCP_B3M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B4M, 3, S2MPS19_IRQ_OCP_B4M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B5M, 3, S2MPS19_IRQ_OCP_B5M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B6M, 3, S2MPS19_IRQ_OCP_B6M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B7M, 3, S2MPS19_IRQ_OCP_B7M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B8M, 3, S2MPS19_IRQ_OCP_B8M_MASK),

	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B9M, 4, S2MPS19_IRQ_OCP_B9M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B10M, 4, S2MPS19_IRQ_OCP_B10M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B11M, 4, S2MPS19_IRQ_OCP_B11M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_B12M, 4, S2MPS19_IRQ_OCP_B12M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OCP_BB, 4, S2MPS19_IRQ_OCP_BB_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_UV_BB, 4, S2MPS19_IRQ_UV_BB_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_BB_NTR_DET, 4, S2MPS19_IRQ_BB_NTR_DET_MASK),

	REGMAP_IRQ_REG(S2MPS19_IRQ_SC_LDO2M, 5, S2MPS19_IRQ_SC_LDO2M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_SC_LDO13M, 5, S2MPS19_IRQ_SC_LDO13M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_SC_LDO14M, 5, S2MPS19_IRQ_SC_LDO14M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_SC_LDO15M, 5, S2MPS19_IRQ_SC_LDO15M_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_SC_LDO28M, 5, S2MPS19_IRQ_SC_LDO28M_MASK),

	REGMAP_IRQ_REG(S2MPS19_IRQ_OC0, 6, S2MPS19_IRQ_OC0_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OC1, 6, S2MPS19_IRQ_OC1_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OC2, 6, S2MPS19_IRQ_OC2_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OC3, 6, S2MPS19_IRQ_OC3_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OC4, 6, S2MPS19_IRQ_OC4_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OC5, 6, S2MPS19_IRQ_OC5_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OC6, 6, S2MPS19_IRQ_OC6_MASK),
	REGMAP_IRQ_REG(S2MPS19_IRQ_OC7, 6, S2MPS19_IRQ_OC7_MASK),
};
...
static const struct regmap_irq_chip s2mps19_irq_chip = {
	.name = "s2mps19",
	.status_base = S2MPS19_COMMON_INT,
	.mask_base = S2MPS19_COMMON_INT_MASK,
	.num_regs = 1,
	.irqs = s2mps19_irqs,
	.num_irqs = ARRAY_SIZE(s2mps19_irqs),
};

static const struct regmap_irq_chip s2mps19_irq_chip_pmic = {
	.name = "s2mps19-pmic",
	.domain_suffix = "pmic",
	.status_base = S2MPS19_PMIC_INT1,
	.mask_base = S2MPS19_PMIC_INT1M,
	.num_regs = 7,
	.irqs = s2mps19_pmic_irqs,
	.num_irqs = ARRAY_SIZE(s2mps19_pmic_irqs),
};
...
static struct regmap_irq_chip_data *sec_irq_init_s2mpg1x(struct sec_pmic_dev *sec_pmic)
{
	...
	case S2MPG11:
		...
		break;
	case S2MPS19:
		irq_chip = &s2mps19_irq_chip;
		chained_irq_chip = &s2mps19_irq_chip_pmic;
		chained_pirq = S2MPS19_COMMON_IRQ_PMIC;
		break;
	default:
